...
(* OASIS_START *)
(* DO NOT EDIT (digest: a36850da6219bd94e607df72a6a947db) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["John Else"];
          homepage = None;
          synopsis = "Simple CLI program for controlling Spotify on Linux";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mpris.clients", None);
                           FindlibPackage ("rresult", None);
                           FindlibPackage ("spotify-web-api", None);
                   ...
                   {exec_custom = false; exec_main_is = "spotify_cli.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\149%:\232\209/\239\193\139\176A\205\\\238\128\005";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
